export const MONACLAW_AGENT_REGISTRY_ADDRESS = (import.meta.env.VITE_MONACLAW_REGISTRY_ADDRESS as `0x${string}`) || "0xd3bca83E959192547782C3a901d5EEB5C90b008E"; // Default to existing registry or placeholder
